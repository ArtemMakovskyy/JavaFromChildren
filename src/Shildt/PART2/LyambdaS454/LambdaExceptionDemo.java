...
//        В этом лямбда-выражении вычисляется среднее число вых
//        значений типа douЫe в массиве
        ...
        System.out.println( "Cpeднee равно "   + average.func(value));
